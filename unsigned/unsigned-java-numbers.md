...
Если каких-то особых требований есть, то выбирайте лучшее, что есть в настоящее время.

Интересна комбинация классов обёрток с переменными большего разряда и с кэшированием, пожалуй, это золотая середина.

В финальной главе мы рассмотрим существующие библиотеки.
